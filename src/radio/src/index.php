  ...
  <div id="smooth-wrapper">
    <div id="smooth-content">
      ...
      <main class="px-15 md:px-30 xl:px-60">
        <section class="h-dvh content-center" id="about">
          <div id="about-canvas" class="w-full h-96 md:h-[30rem] lg:h-[35rem] flex pt-10 relative">
            <div id="about-content"
              class="absolute inset-0 flex flex-col items-center justify-center text-white md:text-2xl lg:text-4xl text-center text-shadow-lg py-4 px-0 md:px-10 tracking-wide">
              <h2
                class="text-5xl md:text-8xl lg:text-9xl bg-gradient-to-tl from-white via-slate-400 to-slate-600 bg-clip-text text-transparent font-bold">
                TCS Radio</h2>
              <p class="text-gray-900 dark:text-gray-200 mt-2">
                Listen, work and enjoy the music.
              </p>
              <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                class="sticky bottom-0 justify-self-center w-24 mt-4" viewBox="0 0 5510.000000 1550.000000"
...
225 -880 0 -880 0 0 -1510z" />
            ...
            <svg
              class="w-full h-full pb-10 lg:pb-0 object-fill opacity-25 dark:opacity-50 blur-sm dark:blur-md z-0 bg-svg"
              viewBox="0 0 350 350" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M215 175L155 209.641V140.359L215 175Z" class="fill-gray-800 dark:fill-white" fill="white" />
              <path d="M119.69 270.402L119.69 79.8767L284.69 175.139L119.69 270.402Z"
                class="stroke-gray-800 dark:stroke-white" stroke-width="15" />
              <path d="M95 313.564L95 36.4355L335.001 175L95 313.564Z" class="stroke-gray-800 dark:stroke-white"
                stroke-width="15" />
            </svg>

          </div>
        </section>
        <section id="projects" class="mt-4 justify-center animate-on-scroll">
          <h2
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2">
            <div>
              <h3 class="text-lg font-semibold">TCS Radio</h3>
              <p class="text-gray-600 dark:text-gray-400">Una plataforma de radio en línea que ofrece una variedad de
                programas y música.</p>
            </div>
            <div
              ...
              <video class="rounded-4xl"
                src="https://videos.pexels.com/video-files/2112426/2112426-hd_1920_1080_30fps.mp4" autoplay loop muted
                playsinline></video>
            </div>
          </div>
        </section>
...
225 -880 0 -880 0 0 -1510z" />
  ...
  <!-- Navegación fija (fuera del smooth scroll) -->
  <nav
    class="w-[-webkit-fill-available] md:w-auto fixed bottom-0 md:left-1/2 md:-translate-x-1/2 z-20 flex justify-center rounded-full m-4 p-4 bg-white bg-clip-padding backdrop-filter backgrop-blur-2xl bg-opacity-10 border-t border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-600">
    <ul class="flex flex-wrap items-center text-sm font-medium text-gray-500 dark:text-gray-400">
      <li>
        <a href="#about" class="me-4 md:me-6">Home</a>
      </li>
      <li>
        <a href="#projects" class="me-4 md:me-6">Projects</a>
      </li>
      <li>
      ...
      <li>
        <a href="#" class="mx-4 md:me-6">Requests</a>
      </li>
      <li>
